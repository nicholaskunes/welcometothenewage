...
def tick():
    ...
    print("minimum is {} USD at {} (L/B: {}) where maximum is {} USD at {} (L/B: {})".format(price_btc.min(), minimum_exchange, ltc_minratio, price_btc.max(), maximum_exchange, ltc_maxratio))
